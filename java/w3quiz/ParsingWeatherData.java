...
public class ParsingWeatherData {
	...
	public static void testlowestHumidityInFile() {
		FileResource fr = new FileResource("./2014/weather-2014-06-29.csv");//q4
    ...
    public static void  testAverageTemperatureInFile() { //q8
    ...
    public static void testAverageTemperatureWithHighHumidityInFile(){
        FileResource fr = new FileResource("./2013/weather-2013-09-02.csv");//q4
        //./2014/weather-2014-06-29.csv
        CSVParser parser = fr.getCSVParser();
	...
	public static void main(String[] args) {
			...
			//1-8: Coldest temperature was 30.0
			//1-23:Coldest temperature was 19.0
			//2-1: Coldest temperature was 26.1
			//12-25: Coldest temperature was 24.1
			//12-30: Coldest temperature was 36.0
			//-------
			//testFileWithColdestTemperature();//q10
			//testlowestHumidityInFile();//q4
			//testLowestHumidityInManyFiles();//q6
			//testAverageTemperatureInFile();//q8
